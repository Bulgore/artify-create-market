...
const Footer = () => {
  const { navigationItems, isLoading } = useNavigation("footer");
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            <h3 className="text-2xl font-bold mb-4">Podsleek</h3>
            <p className="mb-4 text-gray-400">
              Plateforme connectant créateurs et imprimeurs pour des produits uniques.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/artists" className="text-gray-400 hover:text-white transition-colors">Créateurs</Link></li>
              <li><Link to="/printers" className="text-gray-400 hover:text-white transition-colors">Imprimeurs</Link></li>
            </ul>
          </div>
          ...
          <div className="w-full md:w-1/4">
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Email: contact@podsleek.com</li>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© {currentYear} Podsleek. Tous droits réservés.</p>
